...
import org.eclipse.e4.babel.editor.util.OverlayImageIcon;
import org.eclipse.e4.babel.editor.util.OverlayImageIcon.Position;
...
public final class KeyTreeLabelProvider extends LabelProvider implements IFontProvider, IColorProvider {
	...
	if (PropertyPreferences.getInstance().isReportMissingValues()) {
	...
	return OverlayImageIcon.create(baseImage, imageName, location).createImage();
    }
