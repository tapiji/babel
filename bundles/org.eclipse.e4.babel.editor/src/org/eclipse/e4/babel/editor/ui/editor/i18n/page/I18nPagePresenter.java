...
public class I18nPagePresenter implements I18nPageContract.Presenter{
    ...
    public I18nPagePresenter(I18nPageContract.View i18nPageView, IResourceManager resourceManager, ResourceBundleEditorContract.View editorView, IBabelResourceProvider resourceProvider) {
   ...
   private void focusComposite(I18nPageEntryContract.View comp) {
       ...
       if (compPos.y + compSize.y > size.y + origin.y)
    	   ((I18nPageView)i18nPageView).setOrigin(origin.x, origin.y
   ...
   public void focusNextBundleEntryComposite() {
	...
	public static I18nPagePresenter create(I18nPageContract.View i18nPageView, IResourceManager resourceManager, ResourceBundleEditorContract.View editorView, IBabelResourceProvider resourceProvider) {
