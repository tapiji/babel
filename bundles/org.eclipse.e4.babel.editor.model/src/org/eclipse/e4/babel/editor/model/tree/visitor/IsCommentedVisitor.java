 ...
 */
package org.eclipse.e4.babel.editor.model.tree.visitor;
...
import org.eclipse.e4.babel.editor.model.tree.KeyTreeVisitorAdapter;
...
public class IsCommentedVisitor extends KeyTreeVisitorAdapter {
    ...
    public void visitKeyTreeItem(KeyTreeItem item, Object passAlongArgument) {
        ...
        BundleGroup bundleGroup = item.getKeyTree()
                                      .getBundleGroup();
