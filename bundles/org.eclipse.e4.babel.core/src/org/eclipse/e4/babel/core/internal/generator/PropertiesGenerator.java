...
public final class PropertiesGenerator {
	...
	public static final String GENERATED_BY = "# Generated by Tapiji Translator (http://tapiji.github.io/) ";
	...
	private static final String SYSTEM_LINE_SEP = Platform.getPreferencesService().getString(Platform.PI_RUNTIME,"line.separator", System.getProperty("line.separator"), null);
	...
	public static String generate(Bundle bundle) {
		...
		if (headComment != null && headComment.length() > 0) {
			if (PropertyPreferences.getInstance().isGeneratedByEnabled() && !headComment.startsWith(GENERATED_BY)) {
	 ...
	 */
	private static String convertUnicodeToEncoded(String str) {
		int len = str.length();
	 ...
	 */
	private static void appendValue(StringBuffer text, String value, int equalIndex, boolean commented) {
		if (value != null) {
	 ...
	 */
	private static void appendKey(StringBuffer text, String key, int equalIndex, boolean commented) {
